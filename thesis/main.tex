...
\chapter{致谢}
在论文提交之际，谨向读研期间关心和帮助过我的人们表示衷心的感谢。

首先感谢我的导师李书教授在生活、学习和科研上的悉心关怀与耐心指导。
李老师在生活中温润随和，为我提供了安心的科研环境。
在学术方面，老师治学严谨又开放豁达，充分支持我的研究兴趣，指引研究路径，并给予了硬件环境的支持。
我能在研究生阶段找到自己的研究兴趣并付诸实现，离不开李老师的全方位支持。

感谢 Atluri 院士、董雷霆教授在学术上的指导和引领。
他们扎实的理论功底、博学的知识储备与广阔的学术视野让我受益匪浅。
感谢王冠楠、汪雪川、Maryam 三位博士在我访学期间给予的帮助和支持。

感谢 D520 教研室的各位同门，特别是李亦民、杨明浩、江毓彦三位同学，他们在计算环境搭建、程序代码实现中提供了重要的协助。
...
在攻读博士学位期间，主要从事计算力学、直升机气动方向的研究工作。
