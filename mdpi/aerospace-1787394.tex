...
the corresponding $\underline{\hat{U}}^{\mu}$s. It has been proven
...
See \hl{Section}~4.6 in \citep{Toro_2009} for more detailed discussions. %MDPI: Please check and revise Section 4.6 does not exist in the document.
...
\begin{figure}[H] %MDPI: Please check and revise Fiures 24 and 26 are look the same.  %MDPI: Please confirm figures moved after first citations.
...
code publicly available in our GitHub \hl{repository at} \url{https://github.com/pvc1989/miniCFD}
(or the mirror \hl{site} \url{https://gitee.com/pvc1989/miniCFD}), except~the mesh used in Section~\ref{subsec:YF-17}, which was downloaded \hl{from}
...
\abbreviations{Abbreviations}{ %MDPI: Please check can it be merge Abbreviations and Nomenclature to one list.
